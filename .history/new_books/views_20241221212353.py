...
class AuthorBooksEdit(SingleObjectMixin, FormView):
    ...
    def post(self, request, *args, **kwargs):
        self.object = self.get_object(queryset=Author.objects.all())
        formset = AuthorBooksFormset(self.request.POST, instance=self.object)

        if formset.is_valid():  # Validate the formset
            ...
            print("Formset errors:", formset.errors)  # Debugging invalid formset
